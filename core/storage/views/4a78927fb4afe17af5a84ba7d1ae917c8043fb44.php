					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Transfer">
								<li class="nav-item"><a href="<?php echo e(route('admin.ownbank')); ?>" class="nav-link"><i class="icon-office"></i>Own bank</a></li>
								<li class="nav-item"><a href="<?php echo e(route('admin.otherbank')); ?>" class="nav-link"><i class="icon-city"></i>Other bank</a></li>
							</ul>
						</li>											
						<li class="nav-item nav-item-submenu">
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Loan management">
								<li class="nav-item"><a href="<?php echo e(route('admin.loan.hold')); ?>" class="nav-link"><i class="icon-watch"></i>On hold</a></li>
								<li class="nav-item"><a href="<?php echo e(route('admin.loan.pending')); ?>" class="nav-link"><i class="icon-spinner2 spinner"></i>Awaiting payback</a></li>
								<li class="nav-item"><a href="<?php echo e(route('admin.loan.completed')); ?>" class="nav-link"><i class="icon-cup2"></i>Completed</a></li>
							</ul>
						</li>
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><i class="icon-box"></i> <span>Save 4 me</span></a>
							<ul class="nav nav-group-sub" data-submenu-title="Save 4 me">
								<li class="nav-item"><a href="<?php echo e(route('admin.save.completed')); ?>" class="nav-link"><i class="icon-cup2"></i>Completed</a></li>
								<li class="nav-item"><a href="<?php echo e(route('admin.save.pending')); ?>" class="nav-link"><i class="icon-spinner2 spinner"></i>On hold</a></li>
							</ul>
						</li>	
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Deposit">
								...
								<li class="nav-item"><a href="<?php echo e(route('admin.banktransfer')); ?>" class="nav-link"><i class="icon-share2"></i>Bank transfer & logs</a></li>
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Withdraw">
								<li class="nav-item"><a href="<?php echo e(route('admin.withdraw.method')); ?>" class="nav-link"><i class="icon-puzzle4"></i>Withdraw methods</a></li>
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="News Section">
								...
								<li class="nav-item"><a href="<?php echo e(route('admin.brand')); ?>"class="nav-link"><i class="icon-images3"></i>Brands</a></li>
								...
								<li class="nav-item"><a href="<?php echo e(route('admin.branch')); ?>" class="nav-link"><i class="icon-home2"></i>Branches</a></li>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/maxtrade/core/resources/views/master.blade.php ENDPATH**/ ?>