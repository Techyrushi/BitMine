      ...
      <div class="col-md-12">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <?php echo csrf_field(); ?>
              <p>Transfer charge is <?php echo e($set->transfer_charge.$currency->name); ?> per transaction.</p>
...
<?php echo $__env->make('userlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/maxtrade/core/resources/views/user/own_bank.blade.php ENDPATH**/ ?>