          ...
          <div class="timeline timeline-one-side" data-timeline-content="axis" data-timeline-axis-style="dashed">
            <div class="timeline-block">
                ...
                <div class="timeline-content">
                    <small class="text-light font-weight-bold"><?php echo e(date("Y/m/d h:i:A", strtotime($ticket->created_at))); ?></small>
          ...
          <?php $__currentLoopData = $reply; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $df): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($df->status==1): ?>
              <div class="timeline-block">
                ...
                <div class="timeline-content">
                  <small class="text-light font-weight-bold"><?php echo e(date("Y/m/d h:i:A", strtotime($df->created_at))); ?></small>
...
<?php echo $__env->make('userlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/maxtrade-demo/core/resources/views/user/reply-ticket.blade.php ENDPATH**/ ?>