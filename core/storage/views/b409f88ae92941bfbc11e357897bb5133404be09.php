    ...
    <div class="container">
        ...
        <div class="row">
        	<div class="col-md-10 col-sm-10 col-xs-10 center-col last-paragraph-no-margin padding-60px-top padding-60px-bottom">
                <form action="<?php echo e(route('contact-submit')); ?>" method="post" id="modal-details">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                         <div class="col-md-12">
...
<?php $__env->stopSection(); ?>                        
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\maxtrade\core\resources\views/front/contact.blade.php ENDPATH**/ ?>