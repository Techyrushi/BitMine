                                ...
                                <?php echo csrf_field(); ?>
                                    <div class="modal-body">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-10">
                                                <input type="url" name="link" class="form-control" value="<?php echo e($val->value); ?>">
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/maxtrade/core/resources/views/admin/web-control/social-links.blade.php ENDPATH**/ ?>