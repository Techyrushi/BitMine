  ...
  <div class="container-fluid d-flex align-items-center">
    <div class="row">
      ...
      <div class="col-lg-12 col-12 text-right">
          <a href="<?php echo e(route('user.add-merchant')); ?>" class="btn btn-sm btn-neutral">Create merchant</a>
          <a href="<?php echo e(url('/')); ?>/user/merchant-documentation" class="btn btn-sm btn-neutral">Documentation</a>
      </div>
    </div>
  </div>
</div>
...
<?php echo $__env->make('userlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/maxtrade/core/resources/views/user/add-merchant.blade.php ENDPATH**/ ?>