      ...
      <div class="container">
        ...
        <div class="navbar-collapse navbar-custom-collapse collapse" id="navbar-collapse">
          ...
          <ul class="navbar-nav mr-auto">
            <li class="nav-item">
              <a href="<?php echo e(route('login')); ?>" class="nav-link text-dark">
                <span class="nav-link-inner--text">Login</span>
              </a>
            </li>
            <li class="nav-item">
              <a href="<?php echo e(route('register')); ?>" class="nav-link text-dark">
    ...
    <div class="container">
      <div class="row align-items-center justify-content-xl-between">
        <div class="col-xl-6">
          ...
          <a href="<?php echo e(url('/')); ?>" class="font-weight-bold ml-1"><?php echo e($set->site_name); ?></a>  &copy; <?php echo e(date('Y')); ?>. All Rights Reserved. 
          </div>
        </div>
        <div class="col-xl-6">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/maxtrade/core/resources/views/loginlayout.blade.php ENDPATH**/ ?>