                                        ...
                                        <div class="list-icons">
                                            <div class="dropdown">
                                                ...
                                                <?php if($val->status==0): ?>
                                                    ...
                                                    <a class='dropdown-item' href="<?php echo e(url('/')); ?>/admin/declinedeposit/<?php echo e($val->id); ?>"><i class="icon-thumbs-down3 mr-2"></i>Decline request</a>
                                                <?php endif; ?>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/maxtrade-demo/core/resources/views/admin/deposit/index.blade.php ENDPATH**/ ?>