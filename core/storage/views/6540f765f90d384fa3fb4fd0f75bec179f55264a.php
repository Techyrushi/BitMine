                ...
                <div class="col-lg-10">
                  <div class="input-group input-group-merge">
                    ...
                    <div class="input-group-prepend bg-secondary">
                      <span class="input-group-text text-dark">BTC</span>
                    </div>
                  </div>
                </div>
              </div> 
...
<?php echo $__env->make('userlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/anycoin/core/resources/views/user/withdraw.blade.php ENDPATH**/ ?>