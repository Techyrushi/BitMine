                ...
                <ul class="list-unstyled my-4">
                 ...
                 <li>
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <div>
                        <span class="pl-2">Hashrate  <?php echo e($val->hashrate); ?> </span>
                      </div>
                    </div>
                  </li>   
                  ...
                  <li>
                    <div class="d-flex align-items-center">
                      ...
                      <div>
                        <span class="pl-2"><?php echo e($val->upgrade); ?>% profit bonus</span>
                      </div>
                    </div>
                  </li> 
                  <?php endif; ?>               
...
<?php echo $__env->make('userlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/bitmine/core/resources/views/user/plans.blade.php ENDPATH**/ ?>