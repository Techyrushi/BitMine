                ...
                <div class="row align-items-center">
                  <div class="col ml--2">
                    <h4 class="mb-0 text-success">
                      #<?php echo e($val->ref_id); ?>

                    </h4>
                    <p class="text-sm text-white mb-0">Sender: <?php echo e($val->sender['username']); ?></p>
                    <p class="text-sm text-white mb-0">Receiver: <?php echo e($val->receiver['username']); ?></p>
                    <p class="text-sm text-white mb-0">Amount: <?php echo e(substr($val->amount,0,9)); ?>BTC</p>
...
<?php echo $__env->make('userlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\core\resources\views/user/share.blade.php ENDPATH**/ ?>